            ...
            <div class="col-sm-9 content">
                ...
                <!-- <div class="row" id="jaxon-html">
                        ...
                        <div class="col-md-8 margin-vert-10">
                            ...
                            <button type="button" class="btn btn-primary" onclick="Upload.uploadedFile(); return false;" >Upload files</button>
                        </div>
...
<script type='text/javascript'>
    ...
    /*window.onload = function() {
        ...
        {!! $pgw->setColor(pm()->select('colorselect1'), false) !!};
        // Call the HelloWorld class to populate the 2nd div
        {!! $bts->sayHello(0, false) !!};
        // call the HelloWorld->setColor() method on load
        {!! $bts->setColor(pm()->select('colorselect2'), false) !!};
    }*/
    /* ]]> */
</script>
</div>
