<?php
/**
 * Clase que hace relación a tabla producto de la base de datos
 ...
 * 
 * Además la clase Producto tiene las siguientes funciónes:
 * productoFamila($codF) devuelve el nombre del producto que coincida con el código que se le pasa por parámetro
 * getPrecio() devuelve el precio de los productos donde el id de la clase Producto coincida
 */
