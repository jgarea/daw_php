...
/**
 * clienteW2.php
 * A diferencia de los dos clientes anteriores en este caso utilizamos las clases generadas a partir del fichero wsdl
 * Creamos un objeto de la clase generada en este caso ClasesOperacionesService y con el objeto de esa clase accedemos a
 * los metodos que las clases sin utilizar el __soapCall, es una implementación mas limpia del código.
 */
